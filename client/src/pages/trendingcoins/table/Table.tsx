...
import { useGetWatchListQuery } from '../../../service/cryptoApi';
import { localStorageService } from '../../../service/localStorageService';
import { ColorRing } from 'react-loader-spinner';
import axios from 'axios';

const Table = ({ trendingArr }: { trendingArr: Coin[] }) => {
  // const {
  //   data: watchListArr,
  ...
  const [sortedCryptosList, setSortedCryptosList] = useState(trendingArr || []);
  ...
  const fieldSort = (field: any) => {
    ...
    const sortedList = trendingArr ? [...trendingArr] : [];
      ...
      <table className={s.table}>
        ...
        <tbody>
          {Array.isArray(trendingArr) &&
            (sortedCryptosList || trendingArr).map((coin: any) =>
              !coin ? null : (
                <tr key={coin?.id}>
